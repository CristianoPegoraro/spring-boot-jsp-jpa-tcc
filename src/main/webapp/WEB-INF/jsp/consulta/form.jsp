...
$(document).ready(function(){
        ...
        $("input.tipo1").mask("-9.99 -9.99 999º");
        $("input.tipo2").mask("-9.99");
        $("input.tipo3").mask("999º");
});
</script>
							...
							<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<div class="col-xs-12">
									<textarea name="lesometria_obs" type="text"
										class="form-control" rows="2">${consulta.lesometria_obs}</textarea>
...
<label class="col-sm-12 control-label" for="retinoscopia_mem_od">Receita:</label>
					...
					<label class="col-md-12 control-label" for="consulta.observacoes"><br></label>
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
