    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">OptoSistem</a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar ">
            <li><a href="/sistema">Agenda<span class="sr-only"></span></a></li>
            <li><a href="/cliente/novo">Novo Cliente</a> </li>
           <!--  <li><a href="#">Pesquisar Cliente</a></li> -->
              <li><a class="active" href="/cliente/">Lista de Clientes</a></li>
            
          </ul>
          <ul class="nav nav-sidebar">
            <li><a href="/consulta/novo">Nova consulta</a></li>
            <li><a href="/consulta/">Lista de Consultas</a></li>
