...
<script src="/js/mascara/jquery.js"></script>
<script src="/js/mascara/jquery.maskedinput.js"></script>
			...
			<div class="row">
				...
				<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
					...
					<div class="col-xs-12">
							...
							required="Campo Obrigatorio" class="form-control input-md cpf"
							value="${cliente.cpf}">
				...
				<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
					...
					<div class="col-xs-12">
						<input name="rg" type="text" id="rg" maxlength="13"
				...
				<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
					...
					<div class="col-xs-12">
						...
						required="Campo Obrigatorio" class="form-control input-md" value="${cliente.datanasc}">
...
<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
					...
					<div class="col-xs-12">
					<select class="form-control sexo" id="sexo" name="sexo" >
				...
				<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
					...
					<div class="col-xs-12">
						<input name="telefone" type="tel" id="telefone" maxlength="12"
							...
							class="form-control input-md telefone" value="${cliente.telefone}">
				...
				<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
					...
					<div class="col-xs-12">
						<input name="celular" type="tel" id="celular" maxlength="12"
							placeholder="49-3353-9955" pattern="\d{2}\-\d{4}\-\d{4}"
							class="form-control input-md celular" value="${cliente.celular}">
						<form:errors path="cliente.telefone" />
					</div>
				</div>
				...
				<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
					...
					<div class="col-xs-12">
						<input name="cep" type="text" id="cep" placeholder="cep"
							class="form-control input-md cep" value="${cliente.cep}">
