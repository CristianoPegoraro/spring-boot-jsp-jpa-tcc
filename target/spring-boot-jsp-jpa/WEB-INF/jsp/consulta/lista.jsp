...
<%-- ${mensagem}
	<ul>
		<c:forEach items="${consultas}" var="consulta">
			<li><a href="/consulta/editar/${consulta.codigo}">${consulta.observacoes} ${consulta.cliente.nome}</a></li>
		</c:forEach>
	</ul>
	<a href="/consulta/novo">Novo</a>
	</div> --%>
...
<body>
	<div
		class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 table-responsive consultaform">
		<div class="col-md-3">
			<div class="row">
				<h2>Consultas:</h2>
